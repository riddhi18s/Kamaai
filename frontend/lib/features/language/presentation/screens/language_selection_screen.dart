...
class _LanguageSelectionScreenState
  ...
  List<LanguageModel> _filteredLanguages =  SupportedLanguages.all;
  ...
  void initState() {
    super.initState();
    _cardKeys = {
      for (final language in SupportedLanguages.all) language.code: GlobalKey(),
    };
  ...
  void _tryAutoSelectFromSpeech(String text) {
    final matches = SupportedLanguages.all
  ...
  Future<void> _onVoiceLanguageIdentified(LanguageModel language) async {
    ...
    await TTSService.speak(text: language.greeting, languageCode: language.localeCode);
  ...
  Future<void> _handleSpeakerPress() async {
    ...
    await TTSService.speak(
      ...
      languageCode: selected.localeCode,
      onComplete: () {
